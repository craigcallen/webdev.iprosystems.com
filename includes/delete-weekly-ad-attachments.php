<?php
function unattach_weekly_ad_media($post_id) {
    ...
    if ( get_post_type($post_id) == 'weekly-ad' ){
        ...
        $field_key = 'field_646629cddee7b';
        $field_name = 'arg_weekly_ads_files';
...
add_action('acf/save_post', 'unattach_weekly_ad_media', 1);